...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Leverage AI insights for smarter decision-making.",
  },
  {
    icon: (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mt-2 uppercase">
              Drive efficiency, insights, and growth with AI/ML-powered IT & IoT solutions.
            </h2>
            <p className="text-gray-300 mt-4 max-w-xl md:max-w-2xl mx-auto text-sm sm:text-base">
              Unlock smarter operations, faster decisions, and measurable business impact across connected systems.
