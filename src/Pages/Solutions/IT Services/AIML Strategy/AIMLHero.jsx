...
const AIMLHero = () => {
    ...
    //                         alt="AI Illustration"
    //                         className="w-[830px] h-[560px] rounded-2xl"
    //                     />
    //                 </div>

    //                 {/* Right - Text */}
    //                 <div className="text-white text-center md:text-center">
    //                     <p className="uppercase text-[21px] text-[#6FE4FC] font-semibold">our services</p>
    //                     <h1 className="text-5xl md:text-6xl font-bold uppercase">
    //                         AI/ML Strategy and Consulting
    //                     </h1>
    //                     <p className="mt-6 text-gray-300">
    //                         We’ve built an AI-driven platform for launching <br />business transformation.
    //                     </p>
    //                     <button
    //                         className="mt-8 inline-flex items-center justify-center text-[16px] font-semibold leading-[25px] 
    //           text-white bg-[#1B4BF0] py-[15px] px-[60px] rounded-[40px] 
