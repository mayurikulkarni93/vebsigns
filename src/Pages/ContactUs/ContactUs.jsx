...
const ContactSection = () => {
  ...
  const faqs = [
    {
      question: "What does Vebsigns do?",
      answer:
        "We create IT, AI, IoT, and digital marketing solutions that help your business grow.",
    },
    {
      question: "How can Vebsigns help your business?",
      answer:
        "We turn your ideas into smart, scalable, and result-driven digital solutions.",
    },
    {
      question: "How do we solve your challenges?",
      answer:
        "By understanding your goals and delivering end-to-end strategies that work.",
    },
    {
      question: "What’s the process to work with us?",
      answer:
        "Share your vision — we plan, design, and launch to make it real.",
    },
    {
      question: "Why choose Vebsigns?",
      answer:
        "80+ successful projects and 98% happy clients prove our trusted expertise.",
    },
  ];
  const filtered =
    query === ""
    ...
    <div>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto text-center mb-8 sm:mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-white mt-2 uppercase leading-snug sm:leading-tight">
